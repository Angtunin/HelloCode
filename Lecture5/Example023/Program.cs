// Время подсчёта
// Мы рассмотрели рекурсию, узнали, какая она хорошая, классная и не только. Теперь
// рассмотрим обратную сторону этой рекурсии и то, какие проблемы могут возникнуть при её
// использовании.
